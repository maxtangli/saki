...
declare module Photon.Lite {
    class LitePeer extends PhotonPeer {
        ...
        join(roomName: string, roomProperties?: any, actorProperties?: any, broadcast?: boolean): void;
        leave(): void;
        raiseEvent(eventCode: number, data: any): void;
        setActorProperties(actorNr: number, data: any, broadcast: boolean): void;
        getActorProperties(propertyKeys: number[], actorNrs?: number[]): void;
        setRoomProperties(data: any, broadcast: boolean): void;
        getRoomProperties(propertyKeys: number[]): void;
        private isJoined;
        private roomName;
        private room;
        private actors;
...
declare module Photon.LoadBalancing {
    ...
    class LbcPeer extends PhotonPeer {
        webRpc(uriPath: string, parameters: {}): void;
