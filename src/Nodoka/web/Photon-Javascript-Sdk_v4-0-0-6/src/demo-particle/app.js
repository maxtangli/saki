...
var ParticleDemo = (function (_super) {
    ...
    function ParticleDemo(canvas) {
        _super.call(this, ParticleDemoWss ? Photon.ConnectionProtocol.Wss : Photon.ConnectionProtocol.Ws, ParticleDemoAppId, ParticleDemoAppVersion);
        this.canvas = canvas;
        ...
        this.masterStart = false; // set to true to connect directly to default master
            ...
            if (_this.isInLobby()) {
                ...
                if (menu.selectedIndex >= 0 && menu.selectedIndex < _this.availableRooms().length) {
                    ...
                    if (document.getElementById("rejoin").checked) {
                        token = _this.myActor().getJoinToken();
                    }
                    _this.joinRoom(gameId, { joinToken: token });
                }
                else {
