...
- 庄家荣和：放冲者支付 基本点x6。共计 基本点x6。多家和时，放冲者向各家分别支付。
- 闲家荣和：放冲者支付 基本点x4。共计 基本点x4。多家和时，放冲者向各家分别支付。
- 庄家自摸和：各闲家支付 基本点x2。共计 基本点x6。
- 闲家自摸和：各闲家支付 基本点x1，庄家支付 基本点x2。共计 基本点x4。

版本2，区分胜者收入和败者支付

- 庄家荣和：胜者收入 基本点x6。败者支付 各胜者收入之和。
- 闲家荣和：胜者收入 基本点x4。败者支付 各胜者收入之和。
- 庄家自摸和：胜者收入 基本点x6。败者闲家支付 胜者收入/3 等价于 基本点x2，败者庄家 不存在。
- 闲家自摸和：胜者收入 基本x4。败者闲家支付 胜者收入/4 等价于 基本点x1，败者庄家支付 胜者收入/2 等价于 基本点x2。

版本3，合并胜者收入情形

- 荣和：胜者收入 基本点x(胜者为庄家?6:4)。败者闲家支付 各胜者收入之和，败者庄家 不存在。
- 自摸和：胜者收入 基本点x(胜者为庄家?6:4)。败者闲家支付 基本点x(胜者为庄家?2:1)，败者庄家支付 基本点x(胜者为庄家?出错:2)。

版本4，合并胜者收入情形

- 胜者收入：基本点x(胜者为庄家?6:4)。
- 败者支付：荣和时，(败者为闲家?各胜者收入之和:出错)。自摸和时，败者为闲家? 基本点x(胜者为庄家?2:1) : 基本点x(胜者为庄家?出错:2)。

版本5，调整语序以适合程序

- 胜者收入：基本点x(胜者为庄家?6:4)。
- 败者支付-自摸和时：胜者为庄家 ? (败者为庄家?出错:2) : (败者为庄家?2:1)。
- 败者支付-荣和时：胜者为庄家 ? (败者为庄家?出错:各胜者收入之和) : (败者为庄家?出错:各胜者收入之和)。
...
- 立直：任意牌型，门清，有立直宣告。
- 门清自摸FullyConcealedHand：任意牌型，门清，自摸和。
